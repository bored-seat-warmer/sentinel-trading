...
export default function SentimentTradingDashboard() {
  ...
  const analyzeHeadline = useCallback(async (text) => {
    if (!text.trim()) return;
    setLoading(true);
    setError(null);
    setAnalysis(null);
    ...
    const systemPrompt =
      mode === "reactive"
        ? `You are a financial market sentiment analyzer for a real-time news trading system. Analyze the given headline for immediate market impact.
...
Respond ONLY with a JSON object (no markdown, no backticks, no preamble):
{
  ...
  "risks": "1-2 sentence key risk to this trade"
        ...
        : `You are a macro policy analyst for a thesis-driven trading system. Analyze the given policy developments for medium-term sector positioning.
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.modeBar}>
        <button
          onClick={() => { setMode("reactive"); setAnalysis(null); setHeadline(""); }}
          style={{
            ...styles.modeBtn,
        ...
        <button
          onClick={() => { setMode("policy"); setAnalysis(null); setHeadline(""); }}
          style={{
            ...styles.modeBtn,
      ...
      <div style={styles.inputSection}>
        <label style={styles.inputLabel}>
          {mode === "reactive" ? "PASTE A NEWS HEADLINE" : "DESCRIBE POLICY DEVELOPMENTS"}
        </label>
      ...
      {loading && (
        <div style={styles.loadingBox}>
          ...
          <span style={styles.loadingText}>
            {mode === "reactive" ? "Scanning headline for market signals..." : "Mapping policy landscape to sectors..."}
          </span>
        </div>
      )}
              ...
              {mode === "reactive" ? (
                <>
                  ...
                  <div style={styles.severityRow}>
                    ...
                    <span style={styles.severityValue}>{analysis.severity}/10</span>
                  </div>
                  <div
                    style={{
                      ...styles.sentimentTag,
                ...
                <>
                  <div style={{ ...styles.signalBadge, background: "#7b61ff" }}>
                  ...
                  <div style={styles.severityRow}>
                    ...
                    <span style={styles.severityValue}>{analysis.conviction}/10</span>
                  </div>
              ...
              <div key={i} style={styles.historyItem}>
                ...
                <div style={styles.historySignal}>
                  {h.mode === "reactive" ? (
                    ...
                    >
                      {h.analysis.signal?.action} → {h.analysis.signal?.instrument}
                    </span>
                  ) : (
